...
helm repo update
helm install photoprism djjudas21/photoprism
```
...
```console
helm install photoprism djjudas21/photoprism -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/djjudas21/photoprism?modal=changelog)
