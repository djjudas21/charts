...
helm repo update
helm install navidrome djjudas21/navidrome
```
...
```console
helm install navidrome djjudas21/navidrome -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/djjudas21/navidrome?modal=changelog)
